...
namespace Shouldly.Tests.DynamicShouldTests
{
    public class AdditionalInfoScenario : ShouldlyShouldTestScenario
    {
        protected override void ShouldPass()
        {
            ...
            DynamicShould.HaveProperty(testDynamicObject, "Foo", "Some additional context.");
        }
        ...
        protected override string ChuckedAWobblyErrorMessage
        {
            get
            {
                return "Dynamic object \"testDynamicObject\" should contain property \"foo\" but does not." +
                       " Additional Info:" +
