...
{
    public class AdditonalInfoScenario : ShouldlyShouldTestScenario
    {
        ...
        {
            "Fun   with space   and \"quotes\"".ShouldContainWithoutWhitespace("Fun with space and 'quotes'", "Some additional context");
        }
    }
}