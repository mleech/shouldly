...
namespace Shouldly.Tests.Dictionaries.ShouldContainKeyAndValue
{
    public class AdditionalInfoScenario : ShouldlyShouldTestScenario
    {
        ...
        protected override string ChuckedAWobblyErrorMessage
        {
            get
            {
                return "Dictionary \"_dictionary\" should contain key \"bar\" with value \"baz\" but the key does not exist" +
                       " Additional Info:" +
        ...
        {
            _dictionary.ShouldContainKeyAndValue("Foo", "Bar", "Some additional context.");
        }
    }
}